...
public class AppCtxConfig extends BaseJavaConfigDstu2 {
	...
	public DataSource dataSource() {
		...
		retVal.setUrl("jdbc:derby:directory:/var/lib/tomcat7/target/jpaserver_derby_files;create=true");
		retVal.setUsername("");
		retVal.setPassword("");
		return retVal;
	}
	...
	private Properties jpaProperties() {
		...
		extraProperties.put("hibernate.search.default.indexBase", "/var/lib/tomcat7/target/lucenefiles");
